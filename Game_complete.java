...
// y는 x와 중복되지 않게 난수 발생 do-while 사용

    do{
      y= Math.abs(r.nextInt() % 9) + 1;
    }while(y==x);

// z는 x,y와 중복되지 않게 난수 발생 do-while 사용
...
// 1부터 9까지만 입력했는지 확인
        ...
        }else if((usr[0]<0)||(usr[1]<0)||(usr[2]<0)){
          System.out.println("1부터 9까지의 숫자 중 하나를 입력해주세요. 다시 입력해주세요.");
    ...
    }while((count<11) && (strike < 3));
// 10번만 실행 , 스트라이크 3이면 아웃
    return count;
  }
